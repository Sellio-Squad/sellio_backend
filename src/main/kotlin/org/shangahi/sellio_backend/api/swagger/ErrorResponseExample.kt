...
"""
    ...
    const val CART_QUANTITY_EXCEEDS_STOCK = """
    {
      "timestamp": "2025-11-05T21:50:12.995Z",
      "status": 400,
      "error": "Bad Request",
      "message": "Requested quantity exceeds available stock of 10",
      "path": "/v1/cart/items",
      "code": "CART_003"
    }
"""

    const val CART_INVALID_QUANTITY = """
    {
      "timestamp": "2025-11-05T21:50:12.995Z",
      "status": 400,
      "error": "Bad Request",
